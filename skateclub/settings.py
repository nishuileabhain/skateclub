"""
Django settings for skateclub project.
...
WSGI_APPLICATION = 'skateclub.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # potentially can interfere with AWS according to CI
